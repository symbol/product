...
def is_valid_hash_string(hash_string):
	...
	return 2 * Hash256.SIZE == len(hash_string) and _contains_only_alphabet('0123456789ABCDEF', hash_string)


def is_valid_decimal_string(decimal_string):
	"""Determines if the specified string is a valid decimal string."""

	return _contains_only_alphabet('0123456789', decimal_string)

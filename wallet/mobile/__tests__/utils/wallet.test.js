...
describe('utils/wallet', () => {
	...
	describe('createOptInPrivateKeyFromMnemonic', () => {
		...
		it('returns null if the is no public key match in the opt-in white list', () => {
			...
			const mnemonic = 'pizza road phone chase web cancel release hand mail engine custom pole damp envelope fame topple patch asset attract purse venture clay elevator program';

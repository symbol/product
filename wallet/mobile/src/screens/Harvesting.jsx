...
export const Harvesting = observer(() => {
	...
	// UI
	const isButtonDisabled = isNodeListLoading || isStatusLoading || isSummaryLoading || isStarting || isStopping;
					...
					<Animated.View entering={FadeInDown} exiting={FadeOut}>
						...
						{isButtonVisible && (
							<>
								...
								<FormItem>
									<Button title={buttonText} onPress={buttonHandle} isDisabled={isButtonDisabled} />
								</FormItem>
							</>
						)}
					</Animated.View>

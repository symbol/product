...
import { Screen, FormItem, TableView, StyledText, Widget, ButtonPlain } from 'src/components';
...
export const AssetDetails = connect(state => ({
    ...
    return (
        <Screen bottomComponent={<>
            ...
            <FormItem>
                <ButtonPlain icon={require('src/assets/images/icon-primary-explorer.png')} title={$t('button_openTransactionInExplorer')} onPress={handleOpenBlockExplorer} />
            </FormItem>           
        </>}>
            <ScrollView>
                <FormItem type="group">

...
export const AccountAvatar = (props) => {
    ...
    const getAddressImageSrc = () => {
        ...
        switch (addressSecondChar) {
            default:
            case 'A':
                imageSrc = require('src/assets/images/avatars/avatar-1.png');
                break;
            case 'B':
                imageSrc = require('src/assets/images/avatars/avatar-2.png');
                break;
            case 'C':
                imageSrc = require('src/assets/images/avatars/avatar-3.png');
                break;
            case 'D':
                imageSrc = require('src/assets/images/avatars/avatar-4.png');
                break;
        }

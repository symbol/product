 ...
 * @param {function(): void} [onSuccess] - Optional callback triggered when the passcode action succeeds.
 * @param {function(): void} [onCancel] - Optional callback triggered when the passcode action is canceled.
 * @returns {function(): void} - A function that, when called, navigates to the passcode screen and sets up event listeners.
 */

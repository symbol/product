...
import { useDataManager, useNetworkIdentifier, useProp, useValidation } from '@/app/hooks';
import WalletController from '@/app/lib/controller/MobileWalletController';
import { $t } from '@/app/localization';
import { handleError, validateAccountName, validateKey, validateRequired } from '@/app/utils';
import React, { useState } from 'react';

export const AddExternalAccount = props => {
	const networkIdentifier = useNetworkIdentifier();
	const { route } = props;

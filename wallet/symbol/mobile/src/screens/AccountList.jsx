...
export const AccountList = () => {
	...
	const networkAccounts = useMemo(() => accounts[networkIdentifier], [accounts[networkIdentifier]]);
	...
	const fetchBalances = async () => {
		...
		networkAccounts.forEach(account => {
			accountBalanceFetchMap[account.publicKey] = api.account.fetchAccountBalance(networkProperties, account.address);
		});

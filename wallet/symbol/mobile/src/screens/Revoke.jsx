...
import { useDataManager, usePasscode, useProp, useToggle, useTransactionFees, useWalletController } from '@/app/hooks';
import WalletController from '@/app/lib/controller/MobileWalletController';
import { api } from '@/app/lib/api';
import { $t } from '@/app/localization';
import { handleError, mosaicFromDTO } from '@/app/utils';
...
export const Revoke = props => {
	...
	const [fetchSourceAddressMosaicBalance, isBalanceLoading] = useDataManager(
		async () => {
			const { mosaics } = await api.account.fetchAccountInfo(networkProperties, sourceAddress);
			...
			const mosaicInfo = await api.mosaic.fetchMosaicInfo(networkProperties, mosaicId);
			const formattedMosaic = mosaicFromDTO(mosaic, mosaicInfo);

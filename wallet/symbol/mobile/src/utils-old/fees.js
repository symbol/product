...
const DELEGATED_HARVESTING_MESSAGE_STUB = '';
...
export const calculateTransactionFees = (transaction, networkProperties) => {
	...
	const { size } = transactionToSymbol(transaction, transactionOptions);
 ...
 */
export const calculateSingleTransferTransactionSize = ({ messageText, isMessageEncrypted, mosaics = [] }) => {
 ...
 * @returns {TransactionTypes.Transaction} The transaction object.
 */
export const calculateMultisigTransferTransactionSize = options => {
	const signerKeyPair = KEY_PAIR_STUB_1;
	const transferTransaction = calculateSingleTransferTransactionSize(options);
	const transaction = {
 ...
 * @returns {TransactionTypes.Transaction} The transaction object.
 */
export const calculateHarvestingTransactionSize = ({ linkedKeys, type = 'start' }) => {

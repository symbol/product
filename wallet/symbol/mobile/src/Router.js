				...
				{isLoggedIn && (
					<>
						...
						<Stack.Group>
							...
							{/* Bridge screens */}
							<Stack.Screen name={keys.BridgeAccountDetails} component={screens.BridgeAccountDetails} />
							<Stack.Screen name={keys.BridgeAccountList} component={screens.BridgeAccountList} />
							<Stack.Screen name={keys.BridgeSwap} component={screens.BridgeSwap} />
						</Stack.Group>
					</>
				)}
				<Stack.Group screenOptions={{ headerShown: false }}>
...
export class Router {
	...
	static goToBridgeAccountDetails(params) {
		navigationRef.navigate(keys.BridgeAccountDetails, params);
	}
	static goToBridgeAccountList(params) {
		navigationRef.navigate(keys.BridgeAccountList, params);
	}
	static goToBridgeSwap(params) {
		navigationRef.navigate(keys.BridgeSwap, params);
	}
}

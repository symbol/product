...
export const AccountCard = props => {
	const { address, balance, balanceChange, name, isLoading, isActive, type, onRemove } = props;
			...
			<View style={stylesContent}>
				...
				<View>
					...
					{balanceChange && (
						<Animated.View
							...
							key={balanceChange}
						>
							<Text style={styles.textBalanceChange}>{balanceChange + ' ' + config.chains.symbol.ticker}</Text>
						</Animated.View>
					)}
				</View>
				<Animated.View entering={FadeIn} key={balance}>
					<View style={[layout.row, layout.alignEnd]}>
						...
						<Text style={styles.textTicker}>{' ' + config.chains.symbol.ticker}</Text>
					</View>
				</Animated.View>

...
export const DialogBox = props => {
	const { isVisible, isDisabled, type, title, text, body, children, promptValidators, onSuccess, onCancel, style, contentContainerStyle } = props;
					...
					<SafeAreaView style={styles.modalContainer}>
						<View style={[styles.modal, style]}>
							...
							<View style={styles.controls}>
								{!isDisabled && buttons.map((button, index) => (
									<View style={styles.button} key={'modalbtn' + index}>
										<TouchableOpacity 
											onPress={button.handler} 
											style={[styles.buttonPressable, button.style]}
										>

...
/**
 * Value and label pair for a single tab in the TabSelector.
 ...
 * @param {function(): void} props.onPress - Callback fired on tab press.
 ...
 * @param {function(*): void} props.onChange - Callback when selected tab changes, receives the new value.

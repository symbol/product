...
const envMock = {
	...
	NEXT_PUBLIC_NEM_SUPERNODE_API_URL: 'https://supernode.backend',
	NEXT_PUBLIC_NEM_NODELIST_URL: 'https://node.list',
	NEXT_PUBLIC_NEM_MARKET_DATA_URL: 'https://market.data',
	NEXT_PUBLIC_NEM_HISTORICAL_PRICE_URL: 'https://historical.price'
};
process.env = {
	...originalEnv,
	...envMock

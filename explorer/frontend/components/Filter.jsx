		...
		<div className={styles.filter}>
			<div className={styles.list}>
				<div className={styles.button} onClick={clear} role="button">
					<CustomImage src={createAssetURL('/images/icon-chip-clear.png')} className={styles.icon} alt="Clear" />
					...
					data.map((item, index) =>
						selectedItems[item.name] && (
							<div className={styles.selectedItem} key={index} onClick={() => removeFilter(item)}>
								...
								<CustomImage
									src={createAssetURL('/images/icon-close.svg')}
									alt="Remove"
									className={styles.iconRemoveItem}
								/>
							</div>
						))
				}

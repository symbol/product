import * as NamespaceTypes from '@/_variants/symbol/types/Namespace';
import * as NetworkTypes from '@/_variants/symbol/types/Network';
import { addressFromRaw } from '@/_variants/symbol/utils/account';
import { namespaceFromDTO, namespaceIdFromRaw } from '@/_variants/symbol/utils/namespace';
...
export class NamespaceService {
     ...
     * @param {NetworkTypes.NetworkProperties} networkProperties - Network properties.
     * @param {string[]} namespaceIds - Requested namespace ids.
     * @returns {Promise<Record<string, NamespaceTypes.Namespace>>} - The namespaces map.
     */

...
import * as MosaicTypes from '@/_variants/symbol/types/Mosaic';
import * as NetworkTypes from '@/_variants/symbol/types/Network';
import { addressFromRaw } from '@/_variants/symbol/utils/account';
import { absoluteToRelativeAmount, isRestrictableFlag, isRevokableFlag, isSupplyMutableFlag, isTransferableFlag } from '@/_variants/symbol/utils/mosaic';
...
export class MosaicService {
     ...
     * @returns {Promise<Record<string, MosaicTypes.Mosaic>>} - The mosaic infos map.
     */
